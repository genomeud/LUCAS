...
species<-fread("ratio_percentage_S_bad.txt", data.table=F)
...
theme_minimal() + 
labs(x='Classificati / Totale', y='Conteggio', title='Istogramma delle specie classificate bad')
ggsave("Istogramma_classificati_bad.pdf", width=30,units="cm",  plot=graph, device="pdf")