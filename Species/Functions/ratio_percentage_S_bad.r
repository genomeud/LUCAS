...
species<-read.xlsx("correct_summary_S_bad.xlsx")
...
species[4:4,]<-k
write.table(species, "C:/Users/utente/Desktop/UNIVERSITA/Tesi/Analisi/Tabelle/ratio_percentage_S_bad.txt",row.names=F, quote=F)